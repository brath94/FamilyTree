...
exports.createFamily=()=> {
    ...
    KingShanFamily.addMember(amba);
    chit.marry(amba);


    const lika = new Female("Lika");
    KingShanFamily.addMember(lika);
    vich.marry(lika);

    const chitra = new Female("Chitra");
    KingShanFamily.addMember(chitra);
    aras.marry(chitra);

    const vyan = new Male("Vyan");
    KingShanFamily.addMember(vyan);
    satya.marry(vyan);
    ...
    //Vritha
    const vritha = amba.giveBirth("Vritha", "male");
    KingShanFamily.addMember(vritha);

    //dritha marry Jaya
    const jaya = new Male("Jaya");
    KingShanFamily.addMember(jaya);
    dritha.marry(jaya);
   ...
   KingShanFamily.addMember(satvy);
   asva.marry(satvy);
